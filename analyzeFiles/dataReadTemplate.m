function [CL,CD,Re] = dataReadTemplate(dir)
...
% 
% %plot details
% title(['Angle of Attack: ' dir ' Lift,Drag vs. Time'],'FontSize',24,'FontName','Arial')
% xlabel('Time','FontSize',24)
% ylabel('Non-Dimensional Force','FontSize',24)
...
% 
% %plot details
% title(['Lift vs Drag '],'FontSize',24,'FontName','Arial')
% xlabel('Non-Dimensional Horizontal Force','FontSize',24)
% ylabel('Non-Dimensional Vertical Force','FontSize',24)
% 
% 
% 
% 
% %save the plots as a png
% print(['liftdragtime' dir], '-dpng')
% 
% %go to plots directory for this reynolds number and save as png
% dirOrigin = pwd;
% cd ../plots
% print(['liftdragtime' dir], '-dpng')
% %come back to this original directory
% cd ../
% cd(dirOrigin)
